...
function Navbar() {
  ...
  return (
    <header className="w-full bg-white flex flex-col sticky top-0 z-50 shadow-[0_2px_8px_rgba(0,0,0,0.04)] font-sans select-none">
      ...
      <div className="w-full h-[70px] px-4 md:px-6 flex items-center justify-between max-w-[1440px] mx-auto gap-4 lg:gap-6">
        ...
        >
          ...
          />
          <span className="text-[20px] font-black text-gray-900 tracking-tight hidden md:block">
            JioMart
          </span>
        </div>
        ...
        <div className="hidden xl:flex items-center bg-[#f0f4f9] rounded-full p-1 shrink-0">
          <button className="flex items-center gap-1 px-3 py-1 text-[13px] font-extrabold italic text-gray-700 hover:text-gray-900 transition-colors cursor-pointer">
        ...
        <div className="hidden lg:flex items-center gap-2 cursor-pointer group shrink-0 min-w-[160px]">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-1 text-[13px] font-black text-gray-900 leading-none mb-0.5">
              Location
            ...
            <span className="text-[11px] font-medium text-gray-500 leading-none truncate max-w-[160px]">
        ...
        <div className="flex-1 max-w-[480px] h-9 bg-[#f0f4f9] rounded-full flex items-center px-4 border border-transparent focus-within:border-gray-300 focus-within:bg-white focus-within:shadow-[0_0_0_4px_rgba(0,120,173,0.05)] transition-all">
          ...
          <input 
            ...
            className="w-full h-full bg-transparent text-[13px] font-medium text-gray-900 outline-none placeholder-gray-500"
          />
        </div>
        ...
        <div className="flex items-center gap-4 shrink-0 pl-2">
          ...
          {/* Offers (%) */}
          <button className="w-[30px] h-[30px] rounded-full bg-[#555555] hover:bg-gray-700 text-white flex items-center justify-center transition-colors cursor-pointer">
            <span className="font-bold text-[15px] leading-none mb-[1px]">%</span>
          </button>

          {/* Wishlist */}
          <button className="w-[30px] h-[30px] text-[#555555] hover:text-gray-700 transition-colors cursor-pointer flex items-center justify-center">
          ...
          {/* Shopping Cart */}
          <button className="w-[30px] h-[30px] text-[#555555] hover:text-gray-700 transition-colors relative cursor-pointer flex items-center justify-center">
          ...
          <button 
            ...
            className="w-[30px] h-[30px] text-[#555555] hover:text-gray-700 transition-colors cursor-pointer flex items-center justify-center"
          >
      ...
      <div className="w-full bg-white border-t border-gray-100 hidden md:block">
        <div className="max-w-[1440px] mx-auto px-4 md:px-6 pl-[52px] flex items-end overflow-x-auto scrollbar-none h-[40px]">
          ...
          {/* Smart Buys Tab */}
          <button className="bg-[#0078ad] text-white flex items-center gap-1.5 px-3 py-1.5 rounded-t-lg font-bold text-[12px] shrink-0 cursor-pointer h-[34px]">
          ...
          {/* Links Group - Text sizes reduced to 12px */}
          <div className="flex items-center gap-5 px-5 pb-1.5 shrink-0">
            {[
              ...
              <button 
                key={idx} 
                className="flex items-center gap-1.5 text-[12px] font-medium text-gray-600 hover:text-gray-900 transition-colors cursor-pointer"
              >
                <svg className="w-[16px] h-[16px] text-gray-500" fill="currentColor" viewBox="0 0 24 24">
                  <path d={cat.icon} />
                </svg>
                {cat.name}
              </button>
          ...
          <div className="ml-auto flex items-center gap-1 text-[12px] font-medium text-gray-600 cursor-pointer hover:text-gray-900 pb-1.5 shrink-0">
            All Categories 
